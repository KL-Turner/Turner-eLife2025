function [] = CalculateFullSpectroscopy_IOS_nNOS(procDataFileIDs,RestingBaselines)
%----------------------------------------------------------------------------------------------------------
...
for aa = 1:size(procDataFileIDs,1)
    ...
    if isfield(ProcData.data,'HbT') == false
        ...
        if any(strcmp(imagingWavelengths,{'Green','Green & Blue','Red, Green, & Blue'})) == true
            ...
            [~,~,weightedcoeffHbT] = GetHbcoeffs_IOS_nNOS(ledType,bandfilterType,cutfilterType);
