function [ProcData] = PatchPupilData_IOS_nNOS(RawData,ProcData)
%----------------------------------------------------------------------------------------------------------
...
[linkedBlinkIndex] = LinkBinaryEvents_IOS_nNOS(gt(blinkNaNs,0),[RawData.notes.pupilCamSamplingRate,0]); % link greater than 1 second
...
[linkedDiffIndex] = LinkBinaryEvents_IOS_nNOS(gt(diffIndex,0),[RawData.notes.pupilCamSamplingRate*2,0]);
% identify edges for interpolation
edgeFoundB = false;
xx = 1;
startEdgeB = [];
