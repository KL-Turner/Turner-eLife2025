function [procDataFileIDs] = CategorizeData_IOS_nNOS()
%----------------------------------------------------------------------------------------------------------
...
for aa = 1:size(procDataFileIDs,1)
    ...
    if isfield(ProcData,'flags') == false
        ...
        binWhiskers = LinkBinaryEvents_IOS_nNOS(gt(modBinWhiskers,0),[linkThresh breakThresh]*whiskerSamplingRate);
        ...
        [ProcData.flags.whisk] = GetWhiskingData_IOS_nNOS(ProcData,binWhiskers);
        % retrieve details on stiming events
        [ProcData.flags.stim] = GetStimData_IOS_nNOS(ProcData);
        % identify and separate resting data
        [ProcData.flags.rest] = GetRestData_IOS_nNOS(ProcData);
