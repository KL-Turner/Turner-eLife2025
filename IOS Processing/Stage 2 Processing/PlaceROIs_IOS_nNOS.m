function [ROIs] = PlaceROIs_IOS_nNOS(animalID,fileID,ROIs,lensMag,imagingType,imagingWavelengths,imagingCamera)
%----------------------------------------------------------------------------------------------------------
...
if strcmp(imagingCamera,'PCO Edge 5.5') == true
    ...
    for aa = 1:size(procDataFileIDs)
        ...
        [~,procfileDate,~] = GetFileInfo_IOS_nNOS(procDataFileID);
