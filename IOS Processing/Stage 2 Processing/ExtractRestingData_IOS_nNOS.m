function [RestData] = ExtractRestingData_IOS_nNOS(procdataFiles,iteration)
%----------------------------------------------------------------------------------------------------------
...
[dataTypes] = DetermineWavelengthDatatypes_IOS_nNOS(imagingWavelengths,iteration);
...
for aa = 1:length(dataTypes)
    ...
    for bb = 1:length(subDataTypes)
        ...
        for cc = 1:size(procdataFiles,1)
            ...
            [animalID,fileDate,fileID] = GetFileInfo_IOS_nNOS(procdataFile);
