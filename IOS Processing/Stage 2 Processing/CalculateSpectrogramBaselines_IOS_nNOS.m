function [RestingBaselines] = CalculateSpectrogramBaselines_IOS_nNOS(RestingBaselines,baselineType)
%----------------------------------------------------------------------------------------------------------
...
for a = 1:length(neuralDataTypes)
    ...
    uniqueDays = GetUniqueDays_IOS_nNOS(RestingBaselines.(baselineType).baselineFileInfo.fileIDs);
