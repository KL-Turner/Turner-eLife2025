function varargout = SelectBehavioralStateGUI_IOS(varargin)
...
if numargin == 0
    % SELECTBEHAVIORALSTATEGUI_IOS
    % create the GUI only if we are not in the process of loading it
    % already
    gui_Create = true;
elseif local_isInvokeActiveXCallback(gui_State, varargin{:})
    % SELECTBEHAVIORALSTATEGUI_IOS(ACTIVEX,...)
...
elseif local_isInvokeHGCallback(gui_State, varargin{:})
    % SELECTBEHAVIORALSTATEGUI_IOS('CALLBACK',hObject,eventData,handles,...)
    gui_Create = false;
else
