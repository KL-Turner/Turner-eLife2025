...
color_database('blue grotto') = [0.0156862745 0.46274509803 0.81568627451];
color_database('gold') = [1 0.84313725495 0];
color_database('fluorescent green') = [0.22352941176 1 0.07843137254];
...
color_database('caribbean blue') = [0.000000 0.600000 0.800000];
...
color_database('custom green') = [0.000000 0.400000 0.000000];
color_database('custom rest') = [(0/256),(166/256),(81/256)];
color_database('custom nrem') = [(191/256),(0/256),(255/256)];
color_database('custom rem') = [(254/256),(139/256),(0/256)];
color_database('custom whisk') = [(31/256),(120/256),(179/256)];
color_database('custom stim') = [(255/256),(28/256),(206/256)];
color_database('custom alert') = [(255/256),(191/256),(0/256)];
color_database('custom asleep') = [(0/256),(128/256),(255/256)];
color_database('custom all') = [(183/256),(115/256),(51/256)];
color_database('custom green') = [0.000000 0.400000 0.000000];
