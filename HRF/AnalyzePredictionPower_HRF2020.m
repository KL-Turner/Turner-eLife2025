function [AnalysisResults] = AnalyzePredictionPower_HRF2020(animalID,rootFolder,AnalysisResults)
    ...
    for a = 1:length(HRF_hemDataTypes)
        ...
        for b = 1:length(HRF_neuralBands)
            ...
            for c = 1:length(behaviors)
                ...
                [AnalysisResults] = EvaluateCBVPredictionPower_HRF2020(animalID,neuralBand,hemDataType,behavior,AnalysisResults);
            end
        end
    end
    % save data
