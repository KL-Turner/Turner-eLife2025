function [AnalysisResults] = AnalyzeHRF_HRF2020(animalID,saveFigs,rootFolder,delim,AnalysisResults)
    ...
    for a = 1:length(HRF_hemDataTypes)
        ...
        for b = 1:length(HRF_neuralBands)
            ...
            for c = 1:length(behaviors)
                ...
                [AnalysisResults] = CalculateHRFDeconvolution_HRF2020(animalID,neuralBand,hemDataType,behavior,saveFigs,rootFolder,delim,AnalysisResults);
            end
        end
    end
    % save data
