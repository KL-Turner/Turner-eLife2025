function [] = AnalyzePowerSpectrum_LFP_Handler_nNOS(rootFolder,delim,runFromStart)
%----------------------------------------------------------------------------------------------------------
...
for aa = 1:length(groups)
    ...
    for bb = 1:length(animalIDs)
        if isfield(Results_PowerSpec_LFP.(groups{1,aa}),(animalIDs{1,bb})) == false
            [Results_PowerSpec_LFP] = AnalyzePowerSpectrum_LFP_nNOS(animalIDs{1,bb},groups{1,aa},set,rootFolder,delim,Results_PowerSpec_LFP);
        end
