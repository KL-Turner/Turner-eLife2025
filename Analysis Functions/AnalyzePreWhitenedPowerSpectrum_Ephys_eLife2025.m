function [Results_PreWhitenedPowerSpec_Ephys] = AnalyzePreWhitenedPowerSpectrum_Ephys_nNOS(animalID,group,set,rootFolder,delim,Results_PreWhitenedPowerSpec_Ephys)
%----------------------------------------------------------------------------------------------------------
