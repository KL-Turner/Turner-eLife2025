function [Results_PreWhitenedPowerSpec_Ephys] = AnalyzePreWhitenedPowerSpectrum_Ephys(animalID,group,set,rootFolder,delim,Results_PreWhitenedPowerSpec_Ephys)
%----------------------------------------------------------------------------------------------------------
