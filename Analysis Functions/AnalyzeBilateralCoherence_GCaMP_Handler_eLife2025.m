function [] = AnalyzeBilateralCoherence_GCaMP_Handler_nNOS(rootFolder,delim,runFromStart)
%----------------------------------------------------------------------------------------------------------
...
for aa = 1:length(groups)
    ...
    for bb = 1:length(animalIDs)
        if isfield(Results_BilatCoher_GCaMP.(groups{1,aa}),(animalIDs{1,bb})) == false
            [Results_BilatCoher_GCaMP] = AnalyzeBilateralCoherence_GCaMP_nNOS(animalIDs{1,bb},groups{1,aa},set,rootFolder,delim,Results_BilatCoher_GCaMP);
        end
