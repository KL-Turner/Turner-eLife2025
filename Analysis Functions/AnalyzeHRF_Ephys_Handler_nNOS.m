function [] = AnalyzeHRF_Ephys_Handler(rootFolder,delim,runFromStart)
%----------------------------------------------------------------------------------------------------------
...
for aa = 1:length(groups)
    ...
    for bb = 1:length(animalIDs)
        if isfield(Results_HRF_Ephys.(groups{1,aa}),(animalIDs{1,bb})) == false
            [Results_HRF_Ephys] = AnalyzeHRF_Ephys(animalIDs{1,bb},groups{1,aa},set,rootFolder,delim,Results_HRF_Ephys);
        end
