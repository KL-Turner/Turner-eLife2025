function [] = AnalyzePupilCoherence_Ephys_Handler_nNOS(rootFolder,delim,runFromStart)
%----------------------------------------------------------------------------------------------------------
...
for aa = 1:length(groups)
    ...
    for bb = 1:length(animalIDs)
        if isfield(Results_PupilCoher_Ephys.(groups{1,aa}),(animalIDs{1,bb})) == false
            [Results_PupilCoher_Ephys] = AnalyzePupilCoherence_Ephys_nNOS(animalIDs{1,bb},groups{1,aa},set,rootFolder,delim,Results_PupilCoher_Ephys);
        end
