function [Results_PreWhitenedPowerSpec_2P] = AnalyzePreWhitenedPowerSpectrum_2P(animalID,group,set,rootFolder,delim,Results_PreWhitenedPowerSpec_2P)
%----------------------------------------------------------------------------------------------------------
...
save('Results_PreWhitenedPowerSpec_2P.mat','Results_PreWhitenedPowerSpec_2P')
